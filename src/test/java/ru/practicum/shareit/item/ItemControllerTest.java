...
class ItemControllerTest {
    ...
    void createItemTest_whenItemNameIsEmpty_shouldStatus400() {
        ...
        BookingSlimDto booking = new BookingSlimDto(1L, start, end, BookingStatus.WAITING, 2L);
        BookingSlimDto booking2 = new BookingSlimDto(2L, start, end, BookingStatus.WAITING, 2L);
        ItemDto item = new ItemDto(1L, "   ", "desc", true, owner, 1L, booking,
                booking2, new HashSet<>(), new HashSet<>());
        when(itemService.createItem(any(ItemDto.class), anyLong())).thenReturn(item);
    ...
    void createItemTest_whenItemNameIsNull_shouldStatus400() {
        ...
        BookingSlimDto booking = new BookingSlimDto(1L, start, end, BookingStatus.WAITING, 2L);
        BookingSlimDto booking2 = new BookingSlimDto(2L, start, end, BookingStatus.WAITING, 2L);
        ItemDto item = new ItemDto(1L, null, "desc", true, owner, 1L, booking,
                booking2, new HashSet<>(), new HashSet<>());
        when(itemService.createItem(any(ItemDto.class), anyLong())).thenReturn(item);
    ...
    void createItemTest_whenDescriptionIsNull_shouldStatus400() {
        ...
        BookingSlimDto booking = new BookingSlimDto(1L, start, end, BookingStatus.WAITING, 2L);
        BookingSlimDto booking2 = new BookingSlimDto(2L, start, end, BookingStatus.WAITING, 2L);
        ItemDto item = new ItemDto(1L, "name", null, true, owner, 1L, booking,
                booking2, new HashSet<>(), new HashSet<>());
        when(itemService.createItem(any(ItemDto.class), anyLong())).thenReturn(item);
    ...
    void createItemTest_whenAvailableIsNull_shouldStatus400() {
        ...
        BookingSlimDto booking = new BookingSlimDto(1L, start, end, BookingStatus.WAITING, 2L);
        BookingSlimDto booking2 = new BookingSlimDto(2L, start, end, BookingStatus.WAITING, 2L);
        ItemDto item = new ItemDto(1L, "name", "desc", null, owner, 1L, booking,
                booking2, new HashSet<>(), new HashSet<>());
        when(itemService.createItem(any(ItemDto.class), anyLong())).thenReturn(item);
    ...
    void createCommentTest_whenTextIsNull_shouldResponseStatus400() {
        CommentRequestDto commentRequestDto = new CommentRequestDto(null, "   ");
        CommentDto commentDto = new CommentDto(1L, "text", "user", LocalDateTime.now());
        when(itemService.createComment(any(CommentRequestDto.class), anyLong(), anyLong())).thenReturn(commentDto);
