...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> getItemsByTheOwner(long userId, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> getAvailableItem(long userId, String text, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "text", text,
                "from", from,
                "size", size
