...
public interface BookingService {
    ...
    List<BookingDto> getBookingByBooker(State state, Integer from, Integer size, Long userId);

    List<BookingDto> getBookingByOwner(State state, Integer from, Integer size, Long userId);
}
